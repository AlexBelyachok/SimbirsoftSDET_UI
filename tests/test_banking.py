...
class TestBanking:
    ...
    def test_sort_customers_by_first_name(self, manager_page_with_customers: ManagerPage):
        ...
        with allure.step("3. Сортировка по возрастанию и проверка"):
            page.sort_by_first_name()
            sorted_asc = [c['first_name'] for c in page.get_customers_data()]
    ...
    def test_delete_customer(self, manager_page_with_customers: ManagerPage):
        ...
        with allure.step("1. Получение списка клиентов до удаления"):
            customers_before = page.get_customers_data()
        ...
        with allure.step("3. Удаление клиента"):
            page.delete_customer(name_to_delete)
        
        with allure.step("4. Проверка, что клиент удален из списка"):
            customers_after = page.get_customers_data()
